        ...
        <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
          ...
          <div className="bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            ...
            <div className="relative mb-4 w-full">
              <label htmlFor="title" className="leading-7 text-sm text-gray-600">Write something</label>
            ...
            <button onClick={() => { addTodo(); refreshPage();}} className="text-white bg-indigo-500 border-0 py-2 px-8 hover:bg-indigo-600 rounded text-sm">Add Todo</button>
